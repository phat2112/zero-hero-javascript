...
const msgErrNum = 'Inputs have to be positive numbers!';
...
class App {
  ...
  _moveToPopUp(e) {
    ...
    const workoutFound = this.#workout.find(item => item.id === workoutId);
